...
export default function FeatureBuyInExplore() {
  const FeatureBuyIn: Game[] = [
    {
      id: "1",
      title: "",
      image:
        "https://imgxcut.com/game/image/ee6c3b3f63.png?_v=4,dpr=2,width=200",
    ...
    },
    {
      ...
      title: "",
      image:
        "https://imgxcut.com/game/image/13162_Wild Bison Charge™.png?_v=4,dpr=2,width=200",
