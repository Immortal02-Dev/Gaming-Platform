...
export default function BorderCardCarousel({
  title,
  games,
  sectionId,
}: CardCarouselProps) {
  return (
    <>
      ...
      <div className="flex h-fit w-full flex-col rounded-2xl border border-solid border-input p-4">
        ...
        <Swiper
          ...
          breakpoints={{
            640: { slidesPerView: 3, spaceBetween: 10, slidesPerGroup: 3 }, // For screens >= 640px
            1024: { slidesPerView: 3, spaceBetween: 10, slidesPerGroup: 3 }, // For screens >= 1024px
            1280: { slidesPerView: 3, spaceBetween: 10, slidesPerGroup: 3 }, // For screens >= 1280px
          }}
