...
import CasinoThemes from "@/components/modules/themes/CasinoTheme";
import { Banner, Game } from "@/types/game";

import GameLobbyNav from "@/components/shared/navigation/game-filter";

export default function CasinoThemesPage() {
    ...
    <div className="page-content relative z-10 w-full px-4 mx-auto max-w-312">
      <div>
        ...
        <div className="-mx-4 min-h-screen bg-layer2 px-4">
          {/* Game Filter */}
          <GameLobbyNav />
          <div className="grid grid-cols-2 gap-2 py-4 sm:grid-cols-[repeat(auto-fill,minmax(150px,1fr))]">
            <CasinoThemes />
          </div>
        </div>
      </div>
