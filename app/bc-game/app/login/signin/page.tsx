...
export default function SignIn() {
  ...
  const [activeTab, setActiveTab] = useState<"password" | "one-time-code">(
    "password",
  );
  ...
  const handleTabClick = (tab: "password" | "one-time-code") => {
    setActiveTab(tab);
  };
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        // Store auth data using the context login function
      ...
      setError(`Server connection failed. Please try again later. (${err.message})`);
    }
  };
  ...
  return (
    <>
      <div className="absolute left-0 top-0 h-14 w-full items-center bg-layer3 px-4 py-3 flex">
        <span className="text-lg font-extrabold hidden md:block">Sign In</span>
      ...
      <div className="px-6 pt-6 sm:px-12 sm:pt-8">
        ...
        <div
          ...
          style={
            {
              ["--tabs-indicator-position" as any]:
                activeTab === "password" ? "0%" : "100%",
              ["--tabs-width" as any]: "187px",
        ...
        >
          ...
          <button
            aria-selected={activeTab === "one-time-code"}
            className="tabs-btn btn-like"
            onClick={() => handleTabClick("one-time-code")}
          >
            <div className="flex items-center justify-center">
              <div className="icon size-4!">
                <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
        ...
        <div
          className="tabs-content bg-transparent!"
          style={{
            opacity: "1",
          }}
        >
          {activeTab === "password" && (
            <form onSubmit={handleSignIn}>
              ...
              <div className="input pr-2 bg-input_darken mt-3 bg-input_darken">
                <input
              ...
              <div className="flex w-full justify-end">
                <Link
                  className="mt-3 font-extrabold text-secondary hover:text-primary hover:underline inactive"
                  href="/login/forgot"
                >
              ...
              <button
                className="button button-brand button-l mt-6 w-full"
                type="submit"
              >
                <span>Sign In</span>
              </button>
            ...
            <form>
              ...
              <div className="flex w-full justify-center">
                <p className="mt-4 font-semibold text-secondary">
                  <span>We’ll send a 6-digit code to your device</span>
                </p>
              </div>
              <button
                className="button button-brand button-l mt-6 w-full"
