...
export default function TradingSpread() {
  return (
        ...
        <div className="detrade-light detrade theme-bold s768 s1024 s1366 s1440">
          <div className="space-y-0.5">
            ...
            >
              ...
              <div
                className="flex items-center select-none auto-refq2nujsjip6g detrade-popover-trigger cursor-pointer"
              ...
              <div className="flex items-center text-down">
                ...
                <span className="md:text-base font-600">-4.99%</span>
              </div>
            ...
            <div className="relative flex flex-col md:flex-row! gap-0.5">
              ...
              <div
                className="detrade-card relative flex flex-col w-full s768:pr-8"
                id="chart-view"
              >
                <div className="flex flex-wrap items-center justify-between px-3 s768:px-0">
                  <div className="flex items-center flex-nowrap gap-1 whitespace-nowrap text-12">
                    <svg
                      className="detrade-icon auto-ref26rdt6a4s9s detrade-popover-trigger cursor-pointer size-4"
                      fill="none"
                      height="1em"
                      viewBox="0 0 12 12"
                      width="1em"
                  ...
                  <div className="flex items-center gap-4 text-12 font-600 basis-full s768:basis-0 ml-auto">
                    ...
                    <button className="detrade-button hoverable bg-transparent shadow-none! p-0 auto-reflo50dpftgf detrade-popover-trigger cursor-pointer ml-auto s768:ml-0">
                      <svg
                        className="detrade-icon size-4.5"
                        fill="none"
                        height="1em"
                ...
                <div className="relative basis-72 md:basis-125">
                  <TradingChart />
                </div>
                <div className="flex items-center gap-1 flex-col w-6 auto-refkug0s4atl18 detrade-popover-trigger cursor-pointer absolute right-0 top-3 bottom-3">
                  <div className="text-9 text-up">100%</div>
                  <div className="relative flex-1">
                    <div
                      className="absolute z-10 rounded w-3 h-1 -left-1/2"
                      style={{
                        backgroundColor: "rgb(179, 190, 193)",
                        top: "100%",
                      }}
                    />
                    <div className="size-full flex rounded-full overflow-hidden flex-col w-1.5">
                      <div
                        style={{
                          backgroundImage:
                  ...
                  <div className="text-9 text-down">0%</div>
                </div>
              </div>
              <div className="detrade-card w-full md:w-75! space-y-5 s768:p-4 shrink-0">
                <div className="detrade-form-item">
                  ...
                  >
                    <div className="detrade-form-item w-full">
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <div className="auto-refeng7q5rbib8 detrade-popover-trigger cursor-pointer text-secondary border-b border-second border-dotted">
                              Amount(KRWFIAT)
                            </div>
                      ...
                      <div className="detrade-input relative flex flex-nowrap items-center rounded-2 px-3 shadow-sm font-700 transition-all h-10 text-12 s768:h-10 s768:text-14 py-0.75 pr-0.75 flex-grow-max gap-1 shrink-0 min-w-52 text-primary bg-layer5 border-none">
                        <label
                ...
                <div className="detrade-form-item" id="time-periods">
                  <label className="inline-flex mb-2 leading-4 text-secondary text-12 font-500 max-w-full">
                    Time
                  </label>
                  <div
                  ...
                  >
                    <div
                      ...
                      className="relative text-14 leading-4 text-secondary font-500 s768:min-h-10 rounded-2 flex h-10 min-h-10 bg-transparent gap-2 p-0"
                      data-orientation="horizontal"
                      role="tablist"
                      style={{
                        outline: "none",
                    ...
                    >
                      <button
                        aria-controls="radix-:ri:-content-0"
                        aria-selected="true"
                        className="detrade-button shadow-none! relative outline-none whitespace-normal z-10 text-primary font-700 flex-1 py-0.5 px-1 bg-layer5 border border-white/10 transition-opacity duration-300 hover:opacity-100 opacity-100 inline-block"
                        data-orientation="horizontal"
                        data-radix-collection-item=""
                        data-state="active"
                        id="radix-:ri:-trigger-0"
                        role="tab"
                        tabIndex={-1}
                        type="button"
                      >
                        <div className="absolute inset-0 -z-10 rounded-1.5 bg-transparent" />
                        <div>
                          <div className="flex gap-4.5 text-12 leading-4.5 justify-center">
                            <span className="text-center text-14 text-primary font-600">
                              5s
                            </span>
                            <span className="text-center text-12 text-secondary font-600">
                              +100%
                            </span>
                          </div>
                          <div className="w-full h-[0.5px] bg-white/10" />
                          <div className="flex gap-1 justify-center leading-4">
                            <svg
                              className="detrade-icon size-3.5 shrink-0"
                              fill="none"
                              height="1em"
                              viewBox="0 0 12 13"
                              width="1em"
                            ...
                            <div className="spread-value font-400 text-12">
                              0.4
                            </div>
                          </div>
                        </div>
                      ...
                      <button
                        aria-controls="radix-:ri:-content-1"
                        aria-selected="false"
                        className="detrade-button shadow-none! relative outline-none text-tertiary whitespace-normal z-20 font-500 flex-1 py-0.5 px-1 bg-layer5 border border-white/10 transition-opacity duration-300 opacity-30 hover:opacity-100 inline-block"
                        data-orientation="horizontal"
                        data-radix-collection-item=""
                        data-state="inactive"
                        id="radix-:ri:-trigger-1"
                        role="tab"
                        tabIndex={-1}
                        type="button"
                      >
                      ...
                      <button
                        aria-controls="radix-:ri:-content-2"
                        aria-selected="false"
                        className="detrade-button shadow-none! relative outline-none text-tertiary whitespace-normal z-20 font-500 flex-1 py-0.5 px-1 bg-layer5 border border-white/10 transition-opacity duration-300 opacity-30 hover:opacity-100 inline-block"
                        data-orientation="horizontal"
                        data-radix-collection-item=""
                        data-state="inactive"
                        id="radix-:ri:-trigger-2"
                        role="tab"
                        tabIndex={-1}
                        type="button"
                      >
                ...
                <div className="space-y-5" id="up-or-down-button">
                  <div className="detrade-form-item">
                    <label
                      className="inline-flex mb-2 leading-4 text-secondary text-12 font-500 max-w-full"
                      htmlFor=":ra:"
                    >
                      <div className="auto-refp7fc83pt0h8 detrade-popover-trigger cursor-pointer text-secondary border-b border-dotted">
                        Payout
                      </div>
                    </label>
                    <div className="detrade-input relative flex flex-nowrap items-center rounded-2 px-3 border-none shadow-sm font-700 transition-all h-10 s768:h-12 s768:text-16 shrink-0 min-w-60 text-primary bg-layer2 text-12">
                      <div className="flex items-center gap-8 justify-between w-full">
                        <div className="text-up truncate">+$2.00</div>
                        <div className="flex gap-1.5 items-center text-12 font-500 text-secondary">
                          <span>2.00X</span>
                          <span className="inline-block h-4 w-px bg-layer5" />
                          <span>+100%</span>
                        </div>
                      </div>
                      <input
                  ...
                  <div className="detrade-form-item">
                    ...
                    <div
                      className="relative flex h-12 s768:h-16 w-full rounded-2 overflow-hidden s768:-space-x-2"
                      id="up-or-down-button"
                    >
                      <button className="detrade-button hoverable bg-transparent shadow-none! relative h-full flex-1 rounded-none text-white origin-left gap-2 s768:gap-3">
                        <div className="absolute inset-0 z-0 opacity-100! rounded-tr! bg-up origin-bottom-right skew-x-10 s768:skew-x-[16deg]" />
                        <div className="text-18 relative">Up</div>
                        <svg
                      ...
                      <button className="detrade-button hoverable bg-transparent shadow-none! relative h-full flex-1 rounded-none text-white origin-right flex-row-reverse gap-2 s768:gap-3">
                        <div className="absolute inset-0 z-0 opacity-100! rounded-bl! bg-down origin-top-left skew-x-10 s768:skew-x-[16deg]" />
                        <div className="text-18 relative">Down</div>
                        <svg
            ...
            >
              <div className="detrade-scroll-list relative flex overflow-x-auto no-scrollbar select-none rounded-none bg-inherit">
                ...
                >
                  <button
                    aria-controls="radix-:rd:-content-0"
                    aria-selected="false"
                  ...
                  <button
                    aria-controls="radix-:rd:-content-1"
                    aria-selected="false"
                    className="detrade-button bg-transparent shadow-none! relative px-3 outline-none transition-colors duration-300 text-tertiary z-20 font-500"
                    data-orientation="horizontal"
                    data-radix-collection-item=""
                    data-state="inactive"
                    id="radix-:rd:-trigger-1"
                    role="tab"
                    tabIndex={-1}
                    type="button"
                  >
                  ...
                  <button
                    aria-controls="radix-:rd:-content-2"
                    aria-selected="true"
                  ...
                  <button
                    aria-controls="radix-:rd:-content-3"
                    aria-selected="false"
                    className="detrade-button bg-transparent shadow-none! relative px-3 outline-none transition-colors duration-300 text-tertiary z-20 font-500"
                    data-orientation="horizontal"
                    data-radix-collection-item=""
                    data-state="inactive"
                    id="radix-:rd:-trigger-3"
                    role="tab"
                    tabIndex={-1}
                    type="button"
                  >
              ...
              <div
                aria-labelledby="radix-:rd:-trigger-0"
                data-orientation="horizontal"
                data-state="inactive"
                hidden
                id="radix-:rd:-content-0"
                role="tabpanel"
                tabIndex={0}
              />
              <div
                aria-labelledby="radix-:rd:-trigger-1"
                data-orientation="horizontal"
                data-state="inactive"
                hidden
                id="radix-:rd:-content-1"
                role="tabpanel"
                tabIndex={0}
              />
              <div
                aria-labelledby="radix-:rd:-trigger-2"
                data-orientation="horizontal"
                data-state="active"
                id="radix-:rd:-content-2"
                role="tabpanel"
                tabIndex={0}
              >
                <div
                        ...
                        <tbody className="bg-inherit">
                          <tr className="bg-inherit">
                            ...
                            >
                              <div className="flex items-center max-w-20 s1366:max-w-50 gap-1.5">
                                <span className="block overflow-hidden shrink-0 size-6 s768:size-7 rounded-2 lazy-load-image-background  lazy-load-image-loaded">
                                  <img
                                    className="object-cover size-full"
                                    src="https://img2.distributedresourcestorage.com/avatar/103418334/s"
                                  />
                                </span>
                                <div className="truncate">Drey_lqkf1x</div>
                              </div>
                            </td>
                            <td
                              align="left"
                            ...
                            >
                              <div className="flex items-center overflow-hidden">
                                <span className="block overflow-hidden rounded-full shrink-0 size-5 lazy-load-image-background  lazy-load-image-loaded">
                                  <img
                                    className="object-cover size-full"
                                    src="https://currency-trade.s3.ap-east-1.amazonaws.com/icons/STONKS.png"
                                  />
                                ...
                                <svg
                                  className="transition-none text-up shrink-0 pointer-events-none"
                                  fill="none"
                                  height="24"
                                  viewBox="0 0 23 24"
                                  width="23"
                            ...
                            <td
                              ...
                              className="py-2 first:pl-2 last:pr-2 pr-3 first:rounded-l-2 last:rounded-r-2 truncate"
                            >
                              <div className="text-up">1,388.889</div>
                            </td>
                          </tr>
                          <tr className="bg-inherit">
                            <td
                            ...
                            <td
                              ...
                              className="py-2 first:pl-2 last:pr-2 pr-3 first:rounded-l-2 last:rounded-r-2 truncate"
                            >
                              <div className="text-down">-1,388.889</div>
                            </td>
                          </tr>
                          <tr className="bg-inherit">
                            <td
                          ...
                          <tr className="bg-inherit">
                            ...
                            >
                              <div className="flex items-center max-w-20 s1366:max-w-50 gap-1.5">
                                <span className="block overflow-hidden shrink-0 size-6 s768:size-7 rounded-2 lazy-load-image-background  lazy-load-image-loaded">
                                  <img
                                    className="object-cover size-full"
                                    src="https://img2.distributedresourcestorage.com/avatar/99090837/s"
                                  />
                                </span>
                                <div className="truncate">Numfjhdlrycc</div>
                              </div>
                            </td>
                            <td
                              align="left"
                            ...
                            >
                              <div className="flex items-center overflow-hidden">
                                <span className="block overflow-hidden rounded-full shrink-0 size-5 lazy-load-image-background  lazy-load-image-loaded">
                                  <img
                                    className="object-cover size-full"
                                    src="https://currency-trade.s3.ap-east-1.amazonaws.com/icons/ETH.png"
                                  />
                                </span>
                                <div className="flex-1 ml-2 truncate text-14 text-primary">
                                  ETH
                            ...
                            <td
                              ...
                              className="py-2 first:pl-2 last:pr-2 pr-3 first:rounded-l-2 last:rounded-r-2 truncate"
                            >
                              <div className="text-up">70.588</div>
                            </td>
                          </tr>
                          <tr className="bg-inherit">
                            <td
                            ...
                            >
                              <div className="flex items-center overflow-hidden">
                                ...
                                <svg
                                  className="transition-none rotate-180 text-down shrink-0 pointer-events-none"
                                  fill="none"
                                  height="24"
                                  viewBox="0 0 23 24"
                                  width="23"
                            ...
                            >
                              <div className="flex items-center max-w-20 s1366:max-w-50 gap-1.5">
                                <span className="block overflow-hidden shrink-0 size-6 s768:size-7 rounded-2 lazy-load-image-background  lazy-load-image-loaded">
                                  <img
                                    className="object-cover size-full"
                                    src="https://mediatrix.imgix.net/uploads/c24621a6-83dc-4b55-aa5b-5cb732eaaf6c.png"
                                  />
                                </span>
                                <div className="truncate">CoolSoldier476</div>
                              </div>
                            </td>
                            <td
                              align="left"
                          ...
                          <tr className="bg-inherit">
                            ...
                            >
                              <div className="flex items-center max-w-20 s1366:max-w-50 gap-1.5">
                                <span className="block overflow-hidden shrink-0 size-6 s768:size-7 rounded-2 lazy-load-image-background  lazy-load-image-loaded">
                                  <img
                                    className="object-cover size-full"
                                    src="https://img2.distributedresourcestorage.com/avatar/102068403/s"
                                  />
                                </span>
                                <div className="truncate">Mahendra12340</div>
                              </div>
                            </td>
                            <td
                              align="left"
                            ...
                            <td
                              ...
                              className="py-2 first:pl-2 last:pr-2 pr-3 first:rounded-l-2 last:rounded-r-2 truncate"
                            >
                              <div className="text-down">-91.491</div>
                            </td>
                          </tr>
                          <tr className="bg-inherit">
                            <td
                            ...
                            >
                              <div className="flex items-center overflow-hidden">
                                <span className="block overflow-hidden rounded-full shrink-0 size-5 lazy-load-image-background ">
                                  <span
                                    className="object-cover size-full"
                                    style={{
                                      display: "inline-block",
                          ...
                          <tr className="bg-inherit">
                            ...
                            <td
                              ...
                              className="py-2 first:pl-2 last:pr-2 pr-3 first:rounded-l-2 last:rounded-r-2 truncate"
                            >
                              <div className="text-up">91.491</div>
                            </td>
                          </tr>
                          <tr className="bg-inherit">
                            <td
                          ...
                          <tr className="bg-inherit">
                            ...
                            <td
                              ...
                              className="py-2 first:pl-2 last:pr-2 pr-3 first:rounded-l-2 last:rounded-r-2 truncate"
                            >
                              <div className="text-up">96.066</div>
                            </td>
                          </tr>
                        </tbody>
                      </table>
              ...
              <div
                aria-labelledby="radix-:rd:-trigger-3"
                data-orientation="horizontal"
                data-state="inactive"
                hidden
                id="radix-:rd:-content-3"
                role="tabpanel"
                tabIndex={0}
              />
            </div>
