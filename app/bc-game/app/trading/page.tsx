...
export default function TradingPage() {
  return (
    <div className="page-content relative z-10 w-full px-4 sm:px-0">
      <div
        className="relative w-full min-h-[80vh] md:pt-4 pt-0 sm:px-4 mx-auto"
        style={{ maxWidth: "1830px" }}
      >
        <div className="detrade-light detrade theme-bold s768 s1024 s1366 s1440">
          <div className="space-y-0.5" style={{}}>
            ...
            >
              ...
              <div
                className="flex items-center select-none auto-refd5n7hdqbsac detrade-popover-trigger cursor-pointer"
              ...
              <div className="flex items-center text-up">
                ...
                <span className="md:text-base font-600">-16.21%</span>
              </div>
              ...
              >
                <div className="flex flex-wrap items-center justify-between px-3 s768:px-0">
                  <div className="flex items-center flex-nowrap gap-1 whitespace-nowrap text-12">
                    <svg
                      className="detrade-icon auto-refaqgt2evm2og detrade-popover-trigger cursor-pointer size-4"
                      fill="none"
                      height="1em"
                      viewBox="0 0 12 12"
                      width="1em"
                  ...
                  <div className="flex items-center gap-4 text-12 font-600 basis-full s768:basis-0 ml-auto">
                    ...
                    <button className="detrade-button hoverable bg-transparent shadow-none! p-0 auto-ref3pgkmdcs30s detrade-popover-trigger cursor-pointer ml-auto s768:ml-0">
                      <svg
                        className="detrade-icon size-4.5"
                        fill="none"
                        height="1em"
                ...
                <div className="flex items-center gap-1 flex-col w-6 auto-refua788aetrak detrade-popover-trigger cursor-pointer absolute right-0 top-3 bottom-3">
                  <div className="text-9 text-up">50%</div>
                  ...
                  <div className="text-9 text-down">50%</div>
                </div>
              </div>
              <div className="detrade-card w-full md:w-75! space-y-5 s768:p-4 shrink-0">
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <div className="auto-ref76c4pidifk4 detrade-popover-trigger cursor-pointer text-secondary border-b border-second border-dotted">
                              Amount(KRWFIAT)
                            </div>
                ...
                <div className="detrade-form-item" id="time-periods">
                  ...
                  >
                    ...
                    >
                      <button
                        aria-controls="radix-:r2o:-content-0"
                        aria-selected="true"
                        className="detrade-button shadow-none! relative outline-none whitespace-normal z-10 text-primary font-700 flex-1 py-0.5 px-1 bg-layer5 border border-white/10 transition-opacity duration-300 hover:opacity-100 opacity-100"
                        data-orientation="horizontal"
                        data-radix-collection-item=""
                        data-state="active"
                        id="radix-:r2o:-trigger-0"
                        role="tab"
                        tabIndex={-1}
                        type="button"
                      >
                        <div className="absolute inset-0 -z-10 rounded-1.5 bg-transparent" />
                        <div className="text-primary text-14 font-600 flex-1 text-center">
                          5s
                        </div>
                        <div className="flex-1 text-center text-secondary text-12 font-500">
                          +96%
                        </div>
                      </button>
                    </div>
                ...
                <div className="space-y-5" id="up-or-down-button">
                  <div className="detrade-form-item">
                    <label
                      ...
                      htmlFor=":r2g:"
                    >
                      <div className="auto-ref0vvbn5em0co detrade-popover-trigger cursor-pointer text-secondary border-b border-dotted">
                        Payout
                      </div>
                    </label>
                    <div className="detrade-input relative flex flex-nowrap items-center rounded-2 px-3 border-none shadow-sm font-700 transition-all  h-10 s768:h-12 s768:text-16 shrink-0 min-w-60 text-primary bg-layer2 text-12">
                      <div className="flex items-center gap-8 justify-between w-full">
                        <div className="text-up truncate">+$1.96</div>
            ...
            >
              <div className="detrade-scroll-list relative flex overflow-x-auto no-scrollbar select-none rounded-none bg-inherit">
                ...
                >
                  <button
                    aria-controls="radix-:r2j:-content-0"
                    aria-selected="false"
                  ...
                  <button
                    aria-controls="radix-:r2j:-content-1"
                    aria-selected="false"
                    className="detrade-button bg-transparent shadow-none! relative px-3 outline-none transition-colors duration-300 text-tertiary z-20 font-500"
                    data-orientation="horizontal"
                    data-radix-collection-item=""
                    data-state="inactive"
                    id="radix-:r2j:-trigger-1"
                    role="tab"
                    tabIndex={-1}
                    type="button"
                  >
                  ...
                  <button
                    aria-controls="radix-:r2j:-content-2"
                    aria-selected="true"
                  ...
                  <button
                    aria-controls="radix-:r2j:-content-3"
                    aria-selected="false"
                    className="detrade-button bg-transparent shadow-none! relative px-3 outline-none transition-colors duration-300 text-tertiary z-20 font-500"
                    data-orientation="horizontal"
                    data-radix-collection-item=""
                    data-state="inactive"
                    id="radix-:r2j:-trigger-3"
                    role="tab"
                    tabIndex={-1}
                    type="button"
                  >
              ...
              <div
                aria-labelledby="radix-:r2j:-trigger-0"
                data-orientation="horizontal"
                data-state="inactive"
                hidden
                id="radix-:r2j:-content-0"
                role="tabpanel"
                tabIndex={0}
              />
              <div
                aria-labelledby="radix-:r2j:-trigger-1"
                data-orientation="horizontal"
                data-state="inactive"
                hidden
                id="radix-:r2j:-content-1"
                role="tabpanel"
                tabIndex={0}
              />
              <div
                aria-labelledby="radix-:r2j:-trigger-2"
                data-orientation="horizontal"
                data-state="active"
                id="radix-:r2j:-content-2"
                role="tabpanel"
                tabIndex={0}
              >
                <div
                        ...
                        <tbody className="bg-inherit">
                          <tr className="bg-inherit">
                            ...
                            >
                              <div className="flex items-center max-w-20 s1366:max-w-50 gap-1.5">
                                <span className="block overflow-hidden shrink-0 size-6 s768:size-7 rounded-2 lazy-load-image-background  lazy-load-image-loaded">
                                  <img
                                    className="object-cover size-full"
                                    src="https://resource.cwallet.com/head/b2.png"
                                  />
                                </span>
                                <div className="truncate">161***2980</div>
                              </div>
                            </td>
                            <td
                              align="left"
                            ...
                            >
                              <div className="flex items-center overflow-hidden">
                                <span className="block overflow-hidden rounded-full shrink-0 size-5 lazy-load-image-background  lazy-load-image-loaded">
                                  <img
                                    className="object-cover size-full"
                                    src="https://currency-trade.s3.ap-east-1.amazonaws.com/icons/XAU.png"
                                  />
                                </span>
                            ...
                            <td
                              ...
                              className="py-2 first:pl-2 last:pr-2 pr-3 first:rounded-l-2 last:rounded-r-2 truncate"
                            >
                              <div className="text-up">0.757</div>
                            </td>
                          </tr>
                          <tr className="bg-inherit">
                            <td
                            ...
                            <td
                              ...
                              className="py-2 first:pl-2 last:pr-2 pr-3 first:rounded-l-2 last:rounded-r-2 truncate"
                            >
                              <div className="text-down">-1.001</div>
                            </td>
                          </tr>
                          <tr className="bg-inherit">
                            <td
                          ...
                          <tr className="bg-inherit">
                            ...
                            <td
                              ...
                              className="py-2 first:pl-2 last:pr-2 pr-3 first:rounded-l-2 last:rounded-r-2 truncate"
                            >
                              <div className="text-up">0.92</div>
                            </td>
                          </tr>
                          <tr className="bg-inherit">
                            <td
                          ...
                          <tr className="bg-inherit">
                            ...
                            >
                              <div className="flex items-center max-w-20 s1366:max-w-50 gap-1.5">
                                ...
                                <div className="truncate">p***@gmail.com</div>
                              </div>
                            </td>
                            <td
                              align="left"
                            ...
                            <td
                              ...
                              className="py-2 first:pl-2 last:pr-2 pr-3 first:rounded-l-2 last:rounded-r-2 truncate"
                            >
                              <div className="text-up">3.841</div>
                            </td>
                          </tr>
                          <tr className="bg-inherit">
                            <td
                          ...
                          <tr className="bg-inherit">
                            ...
                            >
                              <div className="flex items-center max-w-20 s1366:max-w-50 gap-1.5">
                                ...
                                <div className="truncate">Somto411</div>
                              </div>
                            </td>
                            <td
                              align="left"
                            ...
                            <td
                              ...
                              className="py-2 first:pl-2 last:pr-2 pr-3 first:rounded-l-2 last:rounded-r-2 truncate"
                            >
                              <div className="text-down">-1.01</div>
                            </td>
                          </tr>
                          <tr className="bg-inherit">
                            <td
                          ...
                          <tr className="bg-inherit">
                            ...
                            >
                              <div className="flex items-center max-w-20 s1366:max-w-50 gap-1.5">
                                ...
                                <div className="truncate">Andrew</div>
                              </div>
                            </td>
                            <td
                              align="left"
              ...
              <div
                aria-labelledby="radix-:r2j:-trigger-3"
                data-orientation="horizontal"
                data-state="inactive"
                hidden
                id="radix-:r2j:-content-3"
                role="tabpanel"
                tabIndex={0}
              />
            </div>
