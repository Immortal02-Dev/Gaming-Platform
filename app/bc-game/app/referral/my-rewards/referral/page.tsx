export default function MyRewardsReferral() {
  return (
    <div className="bg-layer2 font-semibold">
      ...
      <section className="relative rounded-xl bg-layer4 pt-2">
        <div
          ...
          style={
            {
              ["--tabs-indicator-position" as any]: "200%",
              ["--tabs-width" as any]: "129px",
            } as React.CSSProperties
          }
        >
          <button className="tabs-btn btn-like">Commission by Friends</button>
