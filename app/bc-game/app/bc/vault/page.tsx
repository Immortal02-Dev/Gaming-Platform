export default function BcVaultPage() {
  return (
    <div>
      <div className="justify-between sm:flex">
        ...
        <div className="bg-layer4 rounded-lg py-3 ml-4 basis-[45%] px-6">
          <div className="bg-layer2 p-1 rounded-md center">
            <div
              className="scroll-x tabs-title hide-scroll w-full bg-transparent!"
              style={
                {
                  ["--tabs-indicator-position" as any]: "0%",
                  ["--tabs-width" as any]: "242px",
            ...
            >
              ...
              <button className="tabs-btn btn-like">Transfer Out</button>
              <div className="tabs-indicator" />
            </div>
            <div className="tabs-content rounded-md!" />
          </div>
          <div className="rounded-xl">
            ...
            <div className="">
              <div className="input text-base">
                ...
                <button
                  className="button button-s select button-input border-none *:bg-transparent"
                  type="button"
                >
                  <div className="flex items-center rounded-lg flex-auto">
                    ...
                    />
                    <div className="text-sm text-left">BC</div>
                  </div>
                </button>
              </div>
            </div>
      ...
      <div className="rounded-lg bg-layerx p-4 min-h-96 sm:mt-5 lg:px-8">
        <div
        ...
        >
          <div className="flex justify-between [&>button]:bg-input_bright">
            <div className="text-secondary center">
              ...
              <span className="text-sm ml-1.5">History</span>
            </div>
            <button
              className="button button-m select bg-input_bright text-base min-w-48"
              type="button"
            >
          ...
          <div className="mt-3 flex flex-none justify-between rounded-xl px-4 py-3 bg-input_bright">
