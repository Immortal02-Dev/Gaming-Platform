...
export default function TortureBlock() {
  return (
            ...
            <div className="bg-primary_brand relative ">
              <div className='w-full relative overflow-hidden after:content-[""] after:block after:w-full after:pt-[56.25%] game-iframe-wrap'>
                <iframe
                  ...
                  src="https://static.crocogaming.com/launcher/static-launcher.html?gameid=155&mode=demo&language=en"
                />
              </div>
            </div>
            ...
            <div className="flex justify-between items-start">
              <div className="flex justify-between items-start">
                <div className="flex flex-col">
                  <span className="font-extrabold text-lg">TORTURE BLOCK</span>
