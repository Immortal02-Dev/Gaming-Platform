    ...
    $.jstree.core.prototype = {
        ...
        redraw_node: function(node, deep, is_callback, force_render) {
            ...
            if ((obj.icon && obj.icon !== true) || obj.icon === false) {
                //íŒŒíŠ¸ë„ˆ ìˆ˜ì •
                if (obj.icon === false || (obj.original.userRoleIdx && obj.original.userRoleIdx == 3)) {
            ...
            if (this.settings.core.force_text) {
                ...
                //íŒŒíŠ¸ë„ˆ ìˆ˜ì •
                if (obj.original.userRoleIdx && obj.original.userRoleIdx == 3) {
                    node.childNodes[1].innerHTML += '<label class="input-group d-inline"><label class="input-group-text d-inline cursor-pointer" style="padding:2px 4px;background-color:' + obj.original.userDistributorColor + '">' + obj.original.userDistributorName + '</label><label class="form-control d-inline cursor-pointer" style="padding:2px 4px">' + obj.original.text + '</label></label>';
                } else {
