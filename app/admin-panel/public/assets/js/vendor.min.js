...
(function() {
    ...
    function(t, e) {
        ...
        var Lt = new RegExp("^(" + tt + ")(?!px)[a-z%]+$", "i"),
            ...
            jt = "[\\x20\\t\\r\\n\\f]",
            Ft = new RegExp("^" + jt + "+|((?:^|[^\\\\])(?:\\\\.)*)" + jt + "+$", "g");

        function qt(t, e, i) {
            var n, s, o, r, a = Ht.test(e),
                l = t.style;
            return (i = i || Wt(t)) && (r = i.getPropertyValue(e) || i[e], a && (r = r.replace(Ft, "$1")), "" !== r || st(t) || (r = w.style(t, e)), !p.pixelBoxStyles() && Lt.test(r) && zt.test(e) && (n = l.width, s = l.minWidth, o = l.maxWidth, l.minWidth = l.maxWidth = l.width = r, r = i.width, l.width = n, l.minWidth = s, l.maxWidth = o)), void 0 !== r ? r + "" : r
        }
        ...
        function Ut(t) {
            return w.cssProps[t] || $t[t] || (t in Xt ? t : $t[t] = function(t) {
                for (var e = t[0].toUpperCase() + t.slice(1), i = Bt.length; i--;)
                    if ((t = Bt[i] + e) in Xt) return t
            }(t) || t)
        }
        ...
        function Zt(t, e, i) {
            ...
            return (!p.boxSizingReliable() && s || !p.reliableTrDimensions() && S(t, "tr") || "auto" === r || !parseFloat(r) && "inline" === w.css(t, "display", !1, n)) && t.getClientRects().length && (s = "border-box" === w.css(t, "boxSizing", !1, n), (o = a in t) && (r = t[a])), (r = parseFloat(r) || 0) + Jt(t, e, i || (s ? "border" : "content"), o, n, r) + "px"
        }
        ...
        w.extend({
            ...
            style: function(t, e, i, n) {
                if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                    var s, o, r, a = $(e),
                        l = Ht.test(e),
                        h = t.style;
                    if (l || (e = Ut(a)), r = w.cssHooks[e] || w.cssHooks[a], void 0 === i) return r && "get" in r && void 0 !== (s = r.get(t, !1, n)) ? s : h[e];
            ...
            css: function(t, e, i, n) {
                var s, o, r, a = $(e);
                return Ht.test(e) || (e = Ut(a)), (r = w.cssHooks[e] || w.cssHooks[a]) && "get" in r && (s = r.get(t, !0, i)), void 0 === s && (s = qt(t, e, n)), "normal" === s && e in Gt && (s = Gt[e]), "" === i || i ? (o = parseFloat(s), !0 === i || isFinite(o) ? o || 0 : s) : s
            }
        }), w.each(["height", "width"], (function(t, e) {
            w.cssHooks[e] = {
                get: function(t, i, n) {
                    if (i) return !Kt.test(w.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? Zt(t, e, n) : Rt(t, Vt, (function() {
                        return Zt(t, e, n)
                    }))
                },
                set: function(t, i, n) {
                    var s, o = Wt(t),
                        ...
                        l = n ? Jt(t, e, n, a, o) : 0;
                    return a && r && (l -= Math.ceil(t["offset" + e[0].toUpperCase() + e.slice(1)] - parseFloat(o[e]) - Jt(t, e, "border", !1, o) - .5)), l && (s = et.exec(i)) && "px" !== (s[3] || "px") && (t.style[e] = i, i = w.css(t, e)), Qt(0, i, l)
                }
            }
            ...
            css: function(t, e) {
                return q(this, (function(t, e, i) {
                    var n, s, o = {},
                        r = 0;
                    if (Array.isArray(e)) {
                        for (n = Wt(t), s = e.length; r < s; r++) o[e[r]] = w.css(t, e[r], !1, n);
                        return o
                    }
        ...
        var ee, ie, ne, se, oe = /^(?:toggle|show|hide)$/,
            re = /queueHooks$/;
        ...
        function ce(t, e, i) {
            for (var n, s = (ue.tweeners[e] || []).concat(ue.tweeners["*"]), o = 0, r = s.length; o < r; o++)
        ...
        function ue(t, e, i) {
            ...
            for (function(t, e) {
                ...
                if (n = ue.prefilters[o].call(h, t, c, h.opts)) return f(n.stop) && (w._queueHooks(h.elem, h.opts.queue).stop = n.stop.bind(n)), n;
        ...
        w.Animation = w.extend(ue, {
            ...
            prefilters: [function(t, e, i) {
                ...
                if ((l = !w.isEmptyObject(e)) || !w.isEmptyObject(p))
                    ...
                    }))), l = ce(g ? m[n] : 0, n, d), n in m || (m[n] = l.start, g && (l.end = l.start, l.start = 0))
            }],
        ...
        }, ne = m.createElement("input"), se = m.createElement("select").appendChild(m.createElement("option")), ne.type = "checkbox", p.checkOn = "" !== ne.value, p.optSelected = se.selected, (ne = m.createElement("input")).value = "t", ne.type = "radio", p.radioValue = "t" === ne.value;
        ...
        w.fn.extend({
            ...
            attr: function(t, e, i) {
                ...
                if (3 !== o && 8 !== o && 2 !== o) return void 0 === t.getAttribute ? w.prop(t, e, i) : (1 === o && w.isXMLDoc(t) || (s = w.attrHooks[e.toLowerCase()] || (w.expr.match.bool.test(e) ? de : void 0)), void 0 !== i ? null === i ? void w.removeAttr(t, e) : s && "set" in s && void 0 !== (n = s.set(t, i, e)) ? n : (t.setAttribute(e, i + ""), i) : s && "get" in s && null !== (n = s.get(t, e)) ? n : null == (n = w.find.attr(t, e)) ? void 0 : n)
            },
            attrHooks: {
                type: {
                    set: function(t, e) {
        ...
        w.fn.extend({
            ...
            addClass: function(t) {
                ...
                })) : (e = _e(t)).length ? this.each((function() {
                    if (n = ve(this), i = 1 === this.nodeType && " " + me(n) + " ") {
            ...
            removeClass: function(t) {
                ...
                })) : arguments.length ? (e = _e(t)).length ? this.each((function() {
                    if (n = ve(this), i = 1 === this.nodeType && " " + me(n) + " ") {
            ...
            toggleClass: function(t, e) {
                ...
                })) : "boolean" == typeof e && a ? e ? this.addClass(t) : this.removeClass(t) : (i = _e(t), this.each((function() {
                    if (a)
                        for (o = w(this), s = 0; s < i.length; s++) n = i[s], o.hasClass(n) ? o.removeClass(n) : o.addClass(n);
                    else void 0 !== t && "boolean" !== r || ((n = ve(this)) && V.set(this, "__className__", n), this.setAttribute && this.setAttribute("class", n || !1 === t ? "" : V.get(this, "__className__") || ""))
                })))
            },
            hasClass: function(t) {
                var e, i, n = 0;
                for (e = " " + t + " "; i = this[n++];)
                    if (1 === i.nodeType && -1 < (" " + me(ve(i)) + " ").indexOf(e)) return !0;
                return !1
            }
        });
        var be = /\r/g;
        w.fn.extend({
            val: function(t) {
                ...
                }))) : s ? (e = w.valHooks[s.type] || w.valHooks[s.nodeName.toLowerCase()]) && "get" in e && void 0 !== (i = e.get(s, "value")) ? i : "string" == typeof(i = s.value) ? i.replace(be, "") : null == i ? "" : i : void 0
            }
        }), w.extend({
            valHooks: {
                option: {
        ...
        w.extend(w.event, {
            trigger: function(e, i, n, s) {
                ...
                if (r = p = a = n = n || m, 3 !== n.nodeType && 8 !== n.nodeType && !ye.test(_ + w.event.triggered) && (-1 < _.indexOf(".") && (_ = (b = _.split(".")).shift(), b.sort()), h = _.indexOf(":") < 0 && "on" + _, (e = e[w.expando] ? e : new w.Event(_, "object" == typeof e && e)).isTrigger = s ? 2 : 3, e.namespace = b.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + b.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), i = null == i ? [e] : w.makeArray(i, [e]), d = w.event.special[_] || {}, s || !d.trigger || !1 !== d.trigger.apply(n, i))) {
                    ...
                    return e.type = _, s || e.isDefaultPrevented() || d._default && !1 !== d._default.apply(v.pop(), i) || !U(n) || h && f(n[_]) && !g(n) && ((a = n[h]) && (n[h] = null), w.event.triggered = _, e.isPropagationStopped() && p.addEventListener(_, we), n[_](), e.isPropagationStopped() && p.removeEventListener(_, we), w.event.triggered = void 0, a && (n[h] = a)), e.result
                }
            },
        ...
        function Ee(t, e, i, n) {
            ...
            if (Array.isArray(e)) w.each(e, (function(e, s) {
                i || Te.test(t) ? n(t, s) : Ee(t + "[" + ("object" == typeof s && null != s ? e : "") + "]", s, i, n)
            }));
        ...
        ze.href = xe.href, w.extend({
            ...
            ajax: function(e, i) {
                ...
                if (v.promise(k), p.url = ((e || p.url || xe.href) + "").replace(Le, xe.protocol + "//"), p.type = i.method || i.type || p.method || p.type, p.dataTypes = (p.dataType || "*").toLowerCase().match(L) || [""], null == p.crossDomain) {
                    l = m.createElement("a");
                    try {
                ...
                if (p.data && p.processData && "string" != typeof p.data && (p.data = w.param(p.data, p.traditional)), Fe(He, p, i, k), h) return k;
                for (u in (c = w.event && p.global) && 0 == w.active++ && w.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !Ne.test(p.type), s = p.url.replace(Pe, ""), p.hasContent ? p.data && p.processData && 0 === (p.contentType || "").indexOf("application/x-www-form-urlencoded") && (p.data = p.data.replace(Ie, "+")) : (d = p.url.slice(s.length), p.data && (p.processData || "string" == typeof p.data) && (s += (ke.test(s) ? "&" : "?") + p.data, delete p.data), !1 === p.cache && (s = s.replace(Me, "$1"), d = (ke.test(s) ? "&" : "?") + "_=" + Ce.guid++ + d), p.url = s + d), p.ifModified && (w.lastModified[s] && k.setRequestHeader("If-Modified-Since", w.lastModified[s]), w.etag[s] && k.setRequestHeader("If-None-Match", w.etag[s])), (p.data && p.hasContent && !1 !== p.contentType || i.contentType) && k.setRequestHeader("Content-Type", p.contentType), k.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Re + "; q=0.01" : "") : p.accepts["*"]), p.headers) k.setRequestHeader(u, p.headers[u]);
                if (p.beforeSend && (!1 === p.beforeSend.call(f, k, p) || h)) return k.abort();
                if (C = "abort", _.add(p.complete), k.done(p.success), k.fail(p.error), n = Fe(We, p, i, k)) {
        ...
        w.ajaxSetup({
            ...
            if (a || "jsonp" === e.dataTypes[0]) return s = e.jsonpCallback = f(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Ue, "$1" + s) : !1 !== e.jsonp && (e.url += (ke.test(e.url) ? "&" : "?") + e.jsonp + "=" + s), e.converters["script json"] = function() {
                return r || w.error(s + " was not called"), r[0]
            }, e.dataTypes[0] = "json", o = t[s], t[s] = function() {
                r = arguments
            }, n.always((function() {
                void 0 === o ? w(t).removeProp(s) : t[s] = o, e[s] && (e.jsonpCallback = i.jsonpCallback, $e.push(s)), r && f(o) && o(r[0]), r = o = void 0
            })), "script"
        })), p.createHTMLDocument = ((Xe = m.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Xe.childNodes.length), w.parseHTML = function(t, e, i) {
            ...
            var n, s, o, r = this,
                a = t.indexOf(" ");
            return -1 < a && (n = me(t.slice(a)), t = t.slice(0, a)), f(e) ? (i = e, e = void 0) : e && "object" == typeof e && (s = "POST"), 0 < r.length && w.ajax({
                url: t,
                type: s || "GET",
                dataType: "html",
                data: e
            ...
            w.cssHooks[e] = Yt(p.pixelPosition, (function(t, i) {
                if (i) return i = qt(t, e), Lt.test(i) ? w(t).position()[e] + "px" : i
            }))
        })), w.each({
            Height: "height",
            Width: "width"
    ...
    function(t, e) {
        ...
        class rn extends q {
            ...
            _getTemplateFactory(t) {
                return this._templateFactory ? this._templateFactory.changeContent(t) : this._templateFactory = new Ki({ ...this._config,
                    content: t,
            ...
            _setListeners() {
                ...
                }, N.on(this._element.closest(Ji), Zi, this._hideModalHandler), this._config.selector ? this._config = { ...this._config,
                    trigger: "manual",
                    selector: ""
                } : this._fixTitle()
            }
