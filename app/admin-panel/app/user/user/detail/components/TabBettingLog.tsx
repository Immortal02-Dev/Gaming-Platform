                ...
                <div className="ms-auto align-self-center d-flex gap-3 fw-bold">
                  <span>
                    ...
                    <span className="text-primary">
                      {summary?.totalBetMoney?.toLocaleString() || 0}
                    </span>
                    원
                  </span>
                  <span>
                    ...
                    <span className="text-success">
                      {summary?.totalWinMoney?.toLocaleString() || 0}
                    </span>
                    원
                  </span>
                  <span>
                    공베팅금 :{" "}
                    <span className="text-primary">
                      {summary?.totalEmptyBetMoney?.toLocaleString() || 0}
                    </span>
                  </span>
                  <span>
                    공당첨금 :{" "}
                    <span className="text-danger">
                      {summary?.totalEmptyWinMoney?.toLocaleString() || 0}
                    </span>
                  </span>
                </div>
              </div>
