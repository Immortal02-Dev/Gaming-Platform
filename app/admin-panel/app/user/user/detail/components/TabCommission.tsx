        ...
        {gameGroup === "0" && (
          <div id="tabContent0">
            ...
            <form
              onSubmit={(e) => {
                e.preventDefault();
                alert("Saved Integrate Charge Bonus");
              }}
            >
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="py-1 text-start ps-3">
                      ...
                      <select
                        name="userIntegrateChargeBonusUseYNType"
                  ...
                  {[1, 2, 3, 4].map((idx) => (
                    <tr key={idx}>
                      ...
                      <td className="py-1 text-start ps-3">
                        ...
                        <input
                          type="text"
                          className="form-control d-inline w-60px me-1"
                        />
                        <span className="me-3">%</span>
                        <span className="me-1">최대</span>
                        <input
                          type="text"
                          className="form-control d-inline w-80px text-end"
                        />
                      </td>
                    </tr>
                  ))}
            ...
            <form
              onSubmit={(e) => {
                e.preventDefault();
                alert("Saved Losing Setting Common");
              }}
            >
              <table className="table table-bordered table-responsive align-middle text-center fw-bold">
                <tbody>
                  <tr>
                    ...
                    <td className="py-1 text-start ps-3">
                      <input
                        type="text"
                        className="form-control d-inline w-80px me-1"
                      />
        ...
        {gameGroup === "2" && (
          <div id="tabContent2">
            ...
            <form
              onSubmit={(e) => {
                e.preventDefault();
                alert("Saved Betting Commission");
              }}
            >
              <table className="table table-bordered table-responsive align-middle text-center fw-bold">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="py-1 text-start ps-3">
                      ...
                      <small className="text-muted ms-2">
                        회원 콤프는 회원 본인만 적용됩니다. 카지노/슬롯 게임에만
                        적용됩니다.
                      </small>
                    </td>
                  </tr>
            ...
            <h5 className="mt-4">
              ...
              <small className="text-danger fs-6">
                - 초기화시 레벨별 설정에 따라 지급 됩니다.
              </small>
            </h5>
            <form
              onSubmit={(e) => {
                e.preventDefault();
                alert("Saved Charge Bonus Setting");
              }}
            >
              <table className="table table-bordered table-responsive align-middle text-center fw-bold">
                <tbody>
                  <tr>
                    ...
                    <td className="py-1 text-start ps-3">
                      ...
                      <input
                        type="text"
                        className="form-control d-inline w-50px me-1"
                        name="firstChargeCommission[2]"
                      />
                      <span className="me-2">%</span>
                      ...
                      <input
                        type="text"
                        className="form-control d-inline w-50px me-1"
                        name="firstChargeCommission[3]"
                      />
                      <span className="me-2">%</span>
                      <span className="me-1">최대 보너스</span>
                      <input
                        type="text"
                        className="form-control d-inline w-70px me-2 text-end"
                        name="firstChargeBonusLimit[2]"
                      />
              ...
              <div className="text-center">
                ...
                <button
                  ...
                  onClick={() => alert("Reset Charge Bonus")}
                >
        ...
        {gameGroup === "5" && (
          <div id="tabContent5">
            <div className="btn-group mb-3">
              <button
                className={`btn ${boardGameTab === "play" ? "btn-primary" : "btn-outline-primary"}`}
                onClick={() => setBoardGameTab("play")}
              >
                플레이홀덤
              </button>
              <button
                className={`btn ${boardGameTab === "papa" ? "btn-primary" : "btn-outline-primary"}`}
                onClick={() => setBoardGameTab("papa")}
              >
                파파홀덤
              </button>
              <button
                className={`btn ${boardGameTab === "wild" ? "btn-primary" : "btn-outline-primary"}`}
                onClick={() => setBoardGameTab("wild")}
              >
                와일드홀덤
              </button>
              <button
                className={`btn ${boardGameTab === "kor" ? "btn-primary" : "btn-outline-primary"}`}
                onClick={() => setBoardGameTab("kor")}
              >
                웹맞고
              </button>
              <button
                className={`btn ${boardGameTab === "baduki" ? "btn-primary" : "btn-outline-primary"}`}
                onClick={() => setBoardGameTab("baduki")}
              >
                웹바둑이
              </button>
              <button
                className={`btn ${boardGameTab === "royal" ? "btn-primary" : "btn-outline-primary"}`}
                onClick={() => setBoardGameTab("royal")}
              >
                로얄홀덤
              </button>
            </div>
            ...
            {boardGameTab === "play" && (
              <div>
                ...
                <form
                  onSubmit={(e) => {
                    e.preventDefault();
                    alert("Saved PlayHoldem Settings");
                  }}
                >
                  <table className="table table-bordered table-responsive align-middle text-center fw-bold">
                    <tbody>
                      <tr>
                        <td className="bg-light w-150px">
                          플레이홀덤 사용유무
                        </td>
                        <td className="py-1 text-start ps-3">
                          <select
