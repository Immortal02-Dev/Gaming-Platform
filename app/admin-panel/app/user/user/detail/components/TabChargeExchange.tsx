                    ...
                    <div className="ms-auto d-flex gap-3">
                      <div className="fw-bold">
                        ...
                        <span className="text-primary">
                          {summary?.approvedAmount?.toLocaleString() || 0}
                        </span>
                        원
                      </div>
                      <div className="fw-bold">
        ...
        <div className="col">
          <table className="table table-striped table-bordered align-middle bg-white text-center fw-bold">
            ...
            <tbody>
              {loading ? (
                <tr>
                  <td colSpan={moneyType === "charge" ? 8 : 6}>Loading...</td>
                </tr>
              ) : logs.length === 0 ? (
                <tr>
                  <td colSpan={moneyType === "charge" ? 8 : 6}>
                    데이터가 없습니다.
                  </td>
                </tr>
              ) : (
                logs.map((log: MoneyLog) => (
                  <tr key={log.id}>
                    ...
                    {moneyType === "charge" && (
                      <td>{log.bonusFirstRate ? "첫충" : "매충"}</td>
                    )}
                    <td>
                      <span
                        className={`badge ${
                    ...
                    <td>
                      {log.requestedAt?.substring(0, 16).replace("T", " ")}
                    </td>
                    <td>
                      {log.processedAt?.substring(0, 16).replace("T", " ")}
                    </td>
                  </tr>
                ))
              )}
