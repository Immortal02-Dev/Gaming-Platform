      ...
      <table className="table table-bordered table-responsive align-middle bg-white text-center fw-bold">
        <tbody>
          ...
          <tr>
            ...
            <td className="bg-gray-300" style={{ width: 180 }}>
              파트너 수수료 등록 / 수정
            </td>
            <td className="p-1 text-left">
              <select
            ...
            <td className="p-1 text-left">
              ...
              >
                <input
                  className="form-check-input"
                  type="checkbox"
                  id="userMoneyChargeAuthUserType"
                  value="1"
                />
          ...
          <tr>
            ...
            <td className="p-1" colSpan={3}>
              <div className="d-flex align-items-center">
                ...
                <label className="col-form-label mx-2">포함</label>
                <select
                  name="userIntegrateChargeBonusAuthType"
                  className="form-select w-auto"
                  defaultValue="0"
                >
                  <option value="0">선택</option>
        ...
        <tbody>
          <tr>
            ...
            <td className="text-start p-1">
              <input
                type="text"
                name="chargeRequestDelayTime"
                className="form-control w-80px d-inline me-2"
                defaultValue=""
              />
          ...
          <tr>
            ...
            <td className="p-1" colSpan={3}>
              <div className="d-flex flex-wrap align-items-center">
                ...
                <span className="col-form-label ms-2 text-danger">
                  * 사이트 설정 : 사이트 설정을 따라갑니다.
                </span>
                <span className="col-form-label ms-2 text-danger">
                  * 이용 불가 : 비밀번호 변경이 불가능합니다.
                </span>
              </div>
            </td>
          </tr>
